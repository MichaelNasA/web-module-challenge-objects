...
console.log('task 1b:', createMenuItem('chocolate milk', 6, 'Drinks'));
...
*/
  ...
  reviews.push({name: 'Brit', rating: 5, feedback: 'this place is great! Delicious food, and awesome atmosphere, would recommend!' });
...
function getLastReview(array) {
  ...
  console.log(`task 7:`, getLastReview(reviews, 5));
